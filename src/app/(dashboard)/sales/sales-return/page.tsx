    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Process product returns and restock inventory.</p>
          </div>
        </div>
      ...
      <div className="grid gap-6 lg:grid-cols-4">
                ...
                <div className="space-y-1">
                  {filteredProducts.map(p => (
                    ...
                    >
                      ...
                      <Badge variant="outline" className="text-[8px] h-4 px-1">₹{p.sellingPrice}</Badge>
                    </button>
                  ))}
                </div>
              )}
        ...
        <div className="lg:col-span-3 space-y-6">
          {/* Return Sheet */}
          <Card className="border-none bg-card shadow-xl overflow-hidden min-h-[400px]">
            <CardHeader className="bg-secondary/20 border-b border-border/50 py-4 flex flex-row items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className="text-lg">Return Sheet</CardTitle>
              ...
              <div className="text-right">
                <p className="text-[9px] font-bold text-muted-foreground uppercase tracking-wider mb-1">Refund Total</p>
              ...
              <Table>
                <TableHeader className="bg-secondary/10">
                  <TableRow className="border-border/50">
                    ...
                    <TableHead className="w-[150px] text-[10px] font-bold uppercase py-3">Sale Price (₹)</TableHead>
